...
class CodebaseSwitcher:
    def __init__(self):
        ...
        self.script_files = ['codebase_switcher.py']
    ...
    def initialize(self):
        ...
        # Create/update gemini and sonnet branches from preedit
        for state in ['gemini', 'sonnet']:
    ...
    def switch_state(self, state):
        ...
        if state not in ['gemini', 'sonnet']:
            print(f"❌ Invalid state. Available: gemini, sonnet")
            return False
